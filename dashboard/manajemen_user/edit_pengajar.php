...
$user_id = $_GET['id'];
 ...
 $query = "SELECT users.*, instructors.spesialisasi, instructors.pengalaman_mengajar_tahun 
          FROM users 
...
<div class="container py-4">
    <div class="card shadow-lg border-0 rounded-lg">
        ...
        <div class="card-body p-4">
          <form action="../../../php/pengajar/update.php" method="POST" class="needs-validation" novalidate>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="spesialisasi" class="form-control" value="<?= htmlspecialchars($data['spesialisasi']) ?>">
                        </div>
                    </div>

                    <!-- Pengalaman Mengajar -->
                    <div class="col-md-6">
                        <label class="form-label fw-bold">Pengalaman Mengajar (tahun)</label>
                        <div class="input-group">
                            <span class="input-group-text bg-light"><i class="fas fa-briefcase text-primary"></i></span>
                            <input type="number" name="pengalaman_mengajar_tahun" class="form-control" value="<?= htmlspecialchars($data['pengalaman_mengajar_tahun']) ?>">
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="input-group">
                            <span class="input-group-text bg-light align-items-start"><i class="fas fa-map-marker-alt text-primary mt-2"></i></span>
                    ...
                    <div class="col-12 mt-4">
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <a href="data_pengajar.php" class="btn btn-outline-secondary me-md-2 px-4">
