...
$query = "SELECT users.*, students.pendidikan_terakhir, students.tanggal_lahir 
          FROM users 
...
<div class="sidebar" id="sidebar">
  ...
  <div class="card border-0 shadow-lg">
    <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center py-3">
        <h3 class="mb-0"><i class="fas fa-user-graduate me-2"></i>Detail Profil Siswa</h3>
        <div>
            <?php if ($is_online): ?>
    ...
    <div class="card-body p-4">
            ...
            <div class="col-md-6">
                ...
                <div class="list-group list-group-flush">
                    ...
                    <div class="list-group-item d-flex justify-content-between align-items-center py-3">
                        ...
                        <span class="fw-bold"><?= date("d M Y", strtotime($data['tanggal_lahir'])) ?></span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="card h-100 border-0 shadow-sm">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <h6 class="text-muted"><i class="fas fa-graduation-cap me-2"></i>Pendidikan Terakhir</h6>
                            <p class="ps-4"><?= htmlspecialchars($data['pendidikan_terakhir']) ?></p>
                        </div>
        ...
        <div class="d-flex justify-content-between mt-4">
            <a href="data_siswa.php" class="btn btn-outline-secondary">
