      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-6">
            ...
            <div class="btn-home text-center text-sm-start">
             
              <a href="login.php" 
                class="btn-first d-block d-sm-inline">
                Mulai Belajar
              </a>

              <a
                href="pendaftaran_kursus.php"
                class="btn-second ms-sm-4 mt-3 mt-sm-0 d-block d-sm-inline"
                >Explore More</a
              >
            </div>
          </div>
